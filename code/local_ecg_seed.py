...
if __name__ == "__main__":
    ...
    train_dataset = get_dataset(
        [
            os.path.join("/data/zyk/data/dataset/ECG/preprocessed/client" + str(args.client_id) + "/train_valid_20_r.csv")
        ],
        base_path="/data/zyk/data/dataset/ECG/preprocessed",
        locations=["client" + str(args.client_id)],
        file_name="records_20.h5",
        n_classes=20
    )

    base_path = "/data/zyk/code/fedmace_benchmark/output/local/client" + str(args.client_id) + "/seed/"
    for batch_size in [32]:
        for lr in [0.1]:
            ...
            logger = Logger(log_name="client" + str(args.client_id), log_file=output_path + "logger.log")
