...
class ScaffoldNonIIDServerHandler(FedAvgNonIIDServerHandler):
    def __init__(
        self,
        lr: float,
        model: torch.nn.Module,
        ...
        super(ScaffoldNonIIDServerHandler, self).__init__(
            model=model,
            test_loaders=test_loaders,
            criterion=criterion,
            output_path=output_path,
...
class ScaffoldNonIIDSerialClientTrainer(FedAvgNonIIDSerialClientTrainer):
    def __init__(
            self,
            model,
            num_clients,
        ...
        super(ScaffoldNonIIDSerialClientTrainer, self).__init__(
            model=model,
            num_clients=num_clients,
            train_loaders=train_loaders,
            test_loaders=test_loaders,
