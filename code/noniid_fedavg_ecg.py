...
from algorithm.ecg.fedavg import FedAvgNonIIDServerHandler, FedAvgNonIIDSerialClientTrainer
...
if __name__ == "__main__":
    ...
    base_path = "/data/zyk/code/fedmace_benchmark/output/fedavg/noniid/seed/"
    ...
    trainer = FedAvgNonIIDSerialClientTrainer(
        model=model,
        num_clients=num_clients,
    ...
    handler = FedAvgNonIIDServerHandler(
        model=model,
        test_loaders=test_loaders,
        criterion=criterion,
        output_path=output_path,
